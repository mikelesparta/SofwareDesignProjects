...
public class Main {
	...
	public static void main(String[] args) {
		...
		// 1. Añadir elementos al mapa -> PATRÓN ADAPTER
		System.out.println("\n 1. Se añaden varios elementos al mapa...");

		database.selectMapElements().stream().forEach(map::add); 	// functional programming

//		for (MapElement element : database.selectMapElements())
//			map.add(element);
